...
.button:hover {
  ...
  color: white;
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">Hello  <span>' .$username. ' Has Made a Transaction but the transaction was not successful</span>,</h1>
    ...
    Fail Transaction === <span>'.$result->msg.'</span>
  
   <p> </span></p>. This is the transaction reciept</p>
