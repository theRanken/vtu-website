...
.button:hover {
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">Hello  <span>' .$username. ' Has Made a Transaction</span>,</h1>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">The Respone to the transaction is.<p>
                        <span><table class"table" >
   <tr>
    <td>Network</td>
    <td><span>'.$result->network.'</span></td>
  </tr>
     <tr>
    <td>Name</td>
    <td><span>'.$result->plan_name.'</span></td>
  </tr>
  <tr>
    <td>Amount</td>
    <td>N<span>'.$result->amount.'</span></td>
  </tr>
  <tr>
    <td>Transaction ID</td>
    <td><span>'.$result->transid.'</span></td>
  </tr>
   <tr>
    <td>New Balance</td>
    <td> N<span>'.$result->newbal.'</span>
    </td>
  </tr>
  <tr>
    <td>Old Balance</td>
    <td><span>'.$result->oldbal.'</span></td>
  </tr>
  <tr>
    <td>Mobile Number</td>
    <td><span>'.$result->mobile_number.'</span></td>
  </tr>
  <tr>
    <td>Status</td>
  ...
  <tr>
    <td>Data Type</td>
    <td><span>'.$result->plan_type.'</span></td>
  </tr>
   <tr>
    <td>Date</td>
    <td><span>'.$result->date.'</span></td>
...
</span></p>. This is the transaction reciept</p>
              ...
              <strong>Amount Due:</strong><span>₦' .$data_price. ' </span>
            </span>
                                  </td>
                                </tr>
                                <tr>
