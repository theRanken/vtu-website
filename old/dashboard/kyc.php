 ...
 $query ="INSERT INTO kyc (username,bank,number,name) 
  VALUES ('$username','$bank','$number','$name')";
   if(mysqli_query($con,$query)) {
       ...
       ?>
        <script>
                 alert("Verfiy account verified succesfully");
  ...
  <?php } ?>
    ...
    <div id="div_id_airtime_type" class="form-group">
            ...
            <label for="id_airtime_type" class=" requiredField">
             ...
             <input type="text" name="number"  class="textinput textInput form-control" required id="numb" onkeyup="checkNumb()">
         </div>
     </div>
...
<div id="div_id_airtime_type" class="form-group">
 ...
 <label for="id_airtime_type" class=" requiredField">
         ...
         <input type="text" name="name"  class="textinput textInput form-control" required id="accountname">
                    ...
                    <button type="submit" class="btn" name="go" style='color: white;' id ="">Verify</button>
 ...
 function checkSelect(b){
    ...
    xhttp.open("GET", "api_calls/acct_num_ver.php?bank_number="+str+"&bank_code="+, true);
    xhttp.send();
}
