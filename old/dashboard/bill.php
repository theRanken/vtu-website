						...
						<ul class="nav nav-primary">
								...
								<div class="collapse" id="utilities">
									<ul class="nav nav-collapse">
										...
										<li>
											<a href="cable.php active"> <span class="sub-item">Cable Subscription</span> </a>
										</li>
									</ul>
								</div>
							</li>
        ...
        <form method="post" id='billform' name="billform" data-plans-url="/ajax/load_plans/" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <input type="hidden" name="csrfmiddlewaretoken" value="R6662esE5vklYSzFjFkqmt7fLJhmoqJF1hginWDUp4rVB733K9nUlsyyko2lZLaR"> 
  ...
  <option value="Postpaid">Postpaid</option>
    ...
    <div id="div_id_customer_name" class="form-group">
            ...
            <label for="id_customer_name" class="">
                ...
                <div class="">
                    <input type="text" name="customer_name" maxlength="250" class="textinput textInput form-control" id="id_customer_name">
    ...
    <div id="div_id_customer_address" class="form-group">
            ...
            <label for="id_customer_address" class="">
                ...
                <div class="">
                    <input type="text" name="customer_address" maxlength="500" class="textinput textInput form-control" id="id_customer_address">
...
swal({
  ...
  text: "Wallet below minimum vending amount N<? $bal; ?>",
  icon: "info",
  button: "ok",
  timer: 60000,
}).then(() => {
