...
<div style="padding:90px 15px 20px 15px" >
    ...
    <h2 class="w3-center">Select A Network below:</h2>
        <div class="box w3-card-4">
         <a style="text-align: center; color:red; display:block; font-size:2em;" href="mtntopup.php"> MTN Network </a> <br>
         <a style="text-align: center; color:red; display:block; font-size:2em;" href="airteltopup.php">Airtel</a> <br>
         <a style="text-align: center; color:red; display:block; font-size:2em;" href="glotopup.php">GLO</a> <br>
         <a style="text-align: center; color:red; display:block; font-size:2em;" href="9mobileairtime.php">9Mobile</a>
