...
if(isset($_POST["send"])){
    ...
    if(empty($phone)){
        ...
        if($plan == '221'){
            //Airtel 500mb gifting 200 => 240
            $charge_amount = 240;
        }
        else if($plan == '222'){
            //Glo 1.0gb gifting 900 => 400
            $charge_amount = 480;
        }
        else if($plan == '223'){
            //Glo 2.0gb gifting 800 => 850
            $charge_amount = 900;
        }
        
        else if($plan == '224'){
            //Glo 5.0gb gifting 2000 => 2500
            $charge_amount = 2500;
        }
...
<select class="form-control" name="plan">
   ...
   <option value="221">AIRTEL 500MB GIFTING => &#8358 240 [30Days]</option>
	<option value="222">AIRTEL 1GB GIFTING => &#8358 480 [30Days]</option>
	<option value="223">AIRTEL 2GB GIFTING => &#8358 900 [30Days]</option>
	<option value="224">AIRTEL 5GB GIFTING => &#8358 2,500 [30Days]</option>
</select>
</div>
 <div class="form-group">
