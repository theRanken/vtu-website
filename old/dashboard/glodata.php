...
if(isset($_POST["send"])){
    ...
    if(empty($phone)){
        ...
        if($plan == '194'){
            //Glo 1.05gb gifting 450 => 470
            $charge_amount = 470;
        }
        else if($plan == '195'){
            //Glo 2.9gb gifting 900 => 940
            $charge_amount = 940;
        }
        else if($plan == '196'){
            //Glo 4.1gb gifting 1350 => 1400
            $charge_amount = 1400;
        }
...
<select class="form-control" name="plan">
    ...
    <option value="194">GLO 1.05GB GIFTING => &#8358 470 [30Days]</option>
	<option value="195">GLO 2.9GB GIFTING => &#8358 940 [30Days]</option>
	<option value="196">GLO 4.1GB GIFTING => &#8358 1,400 [30Days]</option>
</select>
</div>
 <div class="form-group">
