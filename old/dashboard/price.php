	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header bg-secondary-gradient ">
				<a href="#" class="logo" style="color: white;font-size: 19px;font-weight: bold;margin-right: -70px;">Price List</a>
...
<div class="container">
   ...
   <div class="row justify-content-center align-items-center mb-1">
                ...
                ?>
                                <tr>
                                <td style=" font-size:18px; font-weight: bolder;"> <?= ucfirst($mtn['name']);  ?> </td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mtn['price']);  ?></i></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mtn['reseller']);  ?></i></td>
                               <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mtn['top']);  ?></i></td>
							      <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mtn['api']);  ?></i></td>
                              
                                <td style=" font-size:12px;  font-weight: bolder;"><i><?= ucfirst($mtn['day']);  ?></i></td>
                                </tr>
                ...
                ?>
                                <tr>
                                <td style=" font-size:18px; font-weight: bolder;"><?= ucfirst($glo['name']);  ?> </td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($glo['price']);  ?></i></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($glo['reseller']);  ?></i></td>
                               <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($glo['top']);  ?></i></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($glo['api']);  ?></i></td>
                              
                                <td style=" font-size:12px;  font-weight: bolder;"><i><?= ucfirst($glo['day']);  ?></i></td>
                                </tr>
                                <?php } ?>
                ...
                ?>  
                                <tr>
                                <td style=" font-size:18px; font-weight: bolder;"><?= ucfirst($airtel['name']);  ?></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($airtel['price']);  ?></i></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($airtel['reseller']);  ?></i></td>
                               <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($airtel['top']);  ?></i></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($airtel['api']);  ?></i></td>
                              
                                <td style=" font-size:12px;  font-weight: bolder;"><i><?= ucfirst($airtel['day']);  ?></i></td>
                                </tr>
                                <?php }?>
                ...
                ?>  
                                <tr >
                                <td style=" font-size:18px; font-weight: bolder;"><?= ucfirst($mobile['name']);  ?></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mobile['price']);  ?></i></td>
                                <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mobile['reseller']);  ?></i></td>
                               <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mobile['top']);  ?></i></td>
                               <td style=" font-size:18px;  font-weight: bolder;"><i> &#8358;<?= ucfirst($mobile['api']);  ?></i></td>
                              
                                <td style=" font-size:12px;  font-weight: bolder;"><i><?= ucfirst($mobile['day']);  ?></i></td>
                                </tr>
                                <?php } ?>
 ...
 <script type="text/javascript" charset="utf8" src="../../ajax.aspnetcdn.com/ajax/jQuery/jquery-1.8.2.min.js"></script>
  ...
  $(function(){
	...
	<!-- Chart Circle -->
	<script src="../static/dashboard/assets/js/plugin/chart-circle/circles.min.html"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="../static/dashboard/assets/js/plugin/jqvmap/jquery.vmap.min.html"></script>
	<script src="../static/dashboard/assets/js/plugin/jqvmap/maps/jquery.vmap.world.html"></script>

	<!-- Google Maps Plugin -->
	<script src="../static/dashboard/assets/js/plugin/gmaps/gmaps.html"></script>
