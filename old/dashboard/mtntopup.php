           ...
           //Update DB
			...
			amount_used = '$used'
        		...
        		if(mysqli_query($con, $update)){
        			...
        			$insertMTN = "INSERT INTO airtime_transactions(id, airtime_type, network_id, amount_paid_to_customer, phone_recharged, amount_customer_was_charged, network_name, status, date_recharged, customer_id) 
...
<div style="padding:90px 15px 20px 15px" >
    ...
    <h2 class="w3-center">Fill the form below to purchase your MTN Airtime</h2>
