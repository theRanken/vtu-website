...
<select class="form-control" name="plan">
	...
	<option value="216">MTN 500mb GIFTING => &#8358 110 [30Days]</option>
	<option value="6">MTN 500mb SME => &#8358 180 [30Days]</option>
	<option value="217">MTN 1GB GIFTING => &#8358 180 [30Days]</option>
	<option value="7">MTN 1GB SME => &#8358 235 [30Days]</option>
	<option value="209">MTN 2GB GIFTING => &#8358 500 [30Days]</option>
</select>
</div>
 <div class="form-group">
