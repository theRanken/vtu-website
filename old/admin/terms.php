...
<?php
  if (isset($_GET['delete'])) {
    $id =  $_GET['delete'];
    $delete = mysqli_query($con, "DELETE FROM price WHERE id=$id");

    if ($delete) {
      $msg = "<div class='alert alert-danger'>
                              Price has been Deleted </div>";
?>
      <script>
...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
 ...
 <?php
              ...
              if (mysqli_num_rows($result) == 0) {
                $msg = "You Are yet to add a price";
              }
              ?>
              <div class="alas">
                <?= $msg ?>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <center>
                      <a class="btn btn-primary" href="aprice.php?id=<?php echo $use['id']; ?>" title="Edit Moderator"><i class="fa fa-edit"></i></a>
                      <a href="?delete=<?php echo $use['id']; ?>" onclick="return confirm('Do you really want to delete this Price?');" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
