...
$lapp =mysqli_real_escape_string($con, $_POST['lapp']);
$napp = mysqli_real_escape_string($con,$_POST['napp']);
$notif = mysqli_real_escape_string($con,$_POST['notif']);
$status = mysqli_real_escape_string($con,$_POST['status']);
      
  if(!empty($app) && !empty($lapp) && !empty($notif)){
$updat = mysqli_query($con,"UPDATE general SET mobile='$app',bmobile='$lapp',nmobile='$napp',notif='$notif', status='$status'  ") or die(mysqli_error()); 
  ...
  <script>
setTimeout(function(){ window.location.href='site.php' }, 1000);</script>
   ";
...
<form method="POST" >
       ...
       <div class="form-group">
            ...
            <label for="id_username" class=" requiredField">
                App Write UP<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="app"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['mobile']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
              App LinK<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="lapp"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['bmobile']; ?>">
                     </div>
                   </div>
                     
        
            <label for="id_username" class=" requiredField">
                App Botton Name<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="napp"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['nmobile']; ?>">
                     </div>

            <label for="id_username" class=" requiredField">
              Notification<span class="asteriskField"></span>
            </label>
            <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="notif"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['notif']; ?>">
                     </div>
                     
            <label for="id_username" class=" requiredField">
                Allow User To Register<span class="asteriskField"></span>
             </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <select name="status" class="select form-control" required id="adex">
