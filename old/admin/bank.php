...
$price =mysqli_real_escape_string($con, $_POST['price']);
  ...
  if(!empty($price)){
$updat = mysqli_query($con,"UPDATE bank SET price='$price' ") or die(mysqli_error());
  ...
  <script>
setTimeout(function(){ window.location.href='bank.php' }, 1000);</script>
   ";
...
<form method="POST" >
       ...
       <div class="form-group">
          ...
          <label for="id_username" class=" requiredField">
                Front Page Price<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                     <textarea id="textare" name="price" class="textare"  value="<?php echo $pdata['price'];?>" required></textarea>
          </div>
          <script src="ckeditor/ckeditor.js"></script>
                <script>
                    CKEDITOR.replace('textare');
                    <?php
                    require_once "remo.php";
                    ?>
                </script>
