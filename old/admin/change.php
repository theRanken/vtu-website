...
$update = mysqli_query($con,"UPDATE admin SET password1='$password' WHERE id='$id'  ") or die(mysqli_error()); 
...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fa fa-cog" aria-hidden="true"></i> Change Password </h3>
            </div>
</div>
