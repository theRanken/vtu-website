...
$fsecret =mysqli_real_escape_string($con, $_POST['fsecret']);
$psecret =mysqli_real_escape_string($con, $_POST['psecret']);
$plivekey = mysqli_real_escape_string($con,$_POST['plivekey']);
$min = mysqli_real_escape_string($con,$_POST['min']);
$max = mysqli_real_escape_string($con,$_POST['max']);
      
  if(!empty($min) && !empty($max) && !empty($fsecret)){
$updat = mysqli_query($con,"UPDATE pay SET fsecret='$fsecret',psecrect='$psecret',plivekey='$plivekey',min='$min',max='$max'") or die(mysqli_error()); 

    $msg= "
  
  <div class='alert alert-success'>
    Autopayment Setting  Saved
  </div>
 
  <script>
setTimeout(function(){ window.location.href='autopay.php' }, 1000);</script>
   ";
...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fas fa-money-check" aria-hidden="true"></i> Automatic Payment Gateway </h3>
            </div>
</div>
...
<form method="POST" >
       ...
       <div class="form-group">
            ...
            <label for="id_username" class=" requiredField">
                Minimum amount that should be deposited and minimum amount to remain in the user account <span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="min"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['min']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
              Maximum amount that should be deposited<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="max"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['max']; ?>">
                     </div>
                   </div>
                     
        
            <label for="id_username" class=" requiredField">
                Flutterwave Secret Key<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="fsecret"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['fsecret']; ?>">
                     </div>

            <label for="id_username" class=" requiredField">
              Paystack Secret Key<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="psecret"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['psecret']; ?>">
                     </div>
                     
                     <label for="id_username" class=" requiredField">
              Paystack Live Key<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="plivekey"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['plivekey']; ?>">
                     </div>
