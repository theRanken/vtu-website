...
if(isset( $_SESSION['username'])) {
    $sql = mysqli_query($con, "SELECT * FROM coupon");
            if 
            (mysqli_num_rows($sql) > 0){
...
if(isset($_POST['register'])) {
 ...
 if(($codes)==$code){
  $msg="<div class='alert alert-danger'> <span class='btn btn-primary'>$code</span> The Coupon Code has been used,<br> Please try using a different Coupon Code</div>";
  
}else {
  $query1 = "INSERT INTO coupon (code,amount,status,username,date)
    VALUES ('$code','$amount','$status','$username','$date')";
        
        if(mysqli_query($con, $query1)) {
        
    echo "<div class='alert alert-info'><center>".'Success:, New Coupon Code Added..'."</center></div>";
     ?>
           <script>
     ...
     exit;
        ...
        echo "<div class='alert alert-danger'><center>".'An Error Occurs..'."</center></div>";
    }
...
<div class="container">
      <div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          ...
          <a class="btn btn-primary" href="all.php">
...
<form method="POST" >
			 ...
			 <div class="form-group">
			      <div class="row justify-content-center" style="margin-left:0px;margin-right:0px;">
                       <h5><strong><i class="fa fa-user"></i> New Coupon Code.</strong></h5>
                     </div>
                     <div id="div_id_network" class="form-group">
        
            <label for="id_network" class=" requiredField">
                Choose User<span class="asteriskField">*</span>
            </label>
              <div class="">
            ...
            <label for="id_username" class=" requiredField">
                Coupon Code<span class="asteriskField"></span>
                   ...
                   <div class="">
                    ...
                    <input type="text" name="code"  class="textinput textInput form-control" required id="id_username" value="<?php if (isset($code)) echo $code; ?>">
                     </div>
 ...
 <div class="">
     <div class="input-group-addon">
                    <input type="text" name="amount"  maxlength="" class="textinput textInput form-control" required id="id_username" value="<?php if (isset($amount)) echo $amount; ?>">
                     </div>
