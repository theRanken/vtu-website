 ...
 $bal=$adex['bal'];
  ...
  $query ="UPDATE user SET bal='$total' WHERE username='$username' ";
   if(mysqli_query($con,$query)) {
    ...
    $msg='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×</button><strong><span>'.$username.'</span> Has been deducted <span>₦'.$amount.'</span> Successfully</strong></div>';
       ...
       $mail = new PHPMailer();
        $mail->CharSet = "UTF-8";
         ...
         $mail->SMTPAuth = true;
            ...
            $mail->IsHTML(true);
            $mail->setFrom("$sender", "Deducted Email");
