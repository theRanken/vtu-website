...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fa fa-user" aria-hidden="true"></i>Unverified User </h3>
              ...
              <tbody>
                  ...
                  while($user=mysqli_fetch_array($result)){
                    ...
                    if(mysqli_num_rows($result)==0){
                      $msg= "No Unverified User  at the moment";
                  }
                   ?>
               ...
               <tr>
                  ...
                  <center>
                    ...
                    <select class="form-control  " onchange="change_status(this.value,<?php echo $user['id']; ?>)">
 ...
 $.ajax({
     ...
     success: function(result){
           ...
           if(result=='') {
             ...
             $('#str'+id).html('Unverified');
         }
         else if(result==1){
             $('#str'+id).html('Approved');
         }
         else{
             $('#str'+id).html('Banned');
         }
