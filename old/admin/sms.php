...
if(isset( $_SESSION['username'])) {
    $chek = mysqli_query($con,"SELECT * FROM  sms");
...
$updat = mysqli_query($con,"UPDATE sms SET host='$host',apikey='$apikey',username='$username',password='$password'  ") or die(mysqli_error()); 
  ...
  <script>
setTimeout(function(){ window.location.href='sms.php' }, 1000);</script>
   ";
...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fa fa-cog" aria-hidden="true"></i> SMS Setting </h3>
            </div>
</div>

<div class="container box">
   <br />
   <p>The Sms integration, if API key exits Put the apikey, if it doesn't use 0000 as default</p>
<form method="POST" >
