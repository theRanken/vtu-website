...
if(isset($_POST['update'])){
    ...
    $query= "UPDATE coupon SET code='$code', amount='$amount', status='$status'  WHERE id='$id'";
    $result= mysqli_query($con,$query);
    if($result){
   echo "<div style='color:green;'><center>".'Success:, <span style="color:red";> '.$code.'</span> 
...
<?php
        ...
        echo "<div class='alert alert-danger'><center>".'Sorry!! :coupon code was not updated, Please try again Later..'."</center></div>";
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header bg-secondary-gradient ">
				<a href="p" class="logo" style="color: white;font-size: 19px;font-weight: bold;margin-right: -70px;"><?php echo $row['username']?></a>
...
<?php 
      ...
      if(mysqli_num_rows($result) == 1) {
        ...
        ?>
        <div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fa fa-user" aria-hidden="true"></i> Current Coupon Code: 
          <span class="btn btn-primary"> <?php echo  $coded['code']  ; ?></span><br> Username : 
          <span class="btn btn-primary"> <?php echo  $coded['username']  ; ?></span> </h3>
          </div>
          </div>
            ...
            <label for="id_username" class=" requiredField">
                Coupon Code<span class="asteriskField"></span>
                   ...
                   <div class="">
                    ...
                    <input type="text" name="code"  class="textinput textInput form-control" required id="id_username" value="<?php echo $coded['code'];?>">
                     </div>
 ...
 <div class="">
     <div class="input-group-addon">
                    <input type="text" name="amount"  maxlength="" class="textinput textInput form-control" required id="id_username" value="<?php echo $coded['amount'];?>">
                     </div>
        ...
        <div class="">
         ...
         <option value="<?php echo $coded['status'];?>" selected><?php if($coded['status']==0){
                    echo "<span class='btn btn-success' id=str".$coded['id'].">Not Usesd</span>";
                  }; if($coded['status']==1){
                    echo "<span class='btn btn-danger' id=str".$coded['id'].">Used</span>";
                  };?></option><?php if($coded['status']==0){
                  ?>
          <option value="1">Used</option>
          <?
           }else if($coded['status']==1){
               ?>
    ...
    <div class="row justify-content-end"  style="margin-left:0px;margin-right:0px;">
        <div class="form-group">
          <button name="update" class="btn btn-primary fa-pull-right">  Change Coupon Code 
             </button>
        </div>
        </div>
        </div>
