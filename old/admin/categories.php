...
if(isset( $_SESSION['username'])) {
  ...
  $name = $_POST['name']; 
  $type = $_POST['type']; 
   $result=mysqli_query($con,"SELECT * FROM categories WHERE name='$name' AND type='$type'");
  ...
  VALUES ('$name','$type')";
   if(mysqli_query($con,$query)) {
             ...
             echo"<div style='color:green;'><center>".'Success:, <h2 style="color:red";> '.$name.' </h2> categorie has been added to your database succesfully'."</center></div>";
     ?>
 <script>
               document.location.href='acategories.php';
           </script>
           <?php
            exit;
...
<div class="container">
      <div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          ...
          <a class="btn btn-primary" href="acategories.php">
   ...
   <form method="POST" >
			 ...
			 <div class="form-group">
			      <div class="row justify-content-center" style="margin-left:0px;margin-right:0px;">
                       <h5><strong><i class="fas fa-camera"></i> New Category</strong></h5>
                     </div>
        ...
        <div class="">
                    <select name="type" class="select form-control" required id="id_disco_name">
            
         <option value="" selected>---------</option>
          <option value="Airtime TopUp">Airtime TopUp</option>

         <option value="Data Subcription">Data Subcription</option>
         <option value="Cable Subcription">Cable Subcription</option>
         </select>
