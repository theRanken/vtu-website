...
$msg1="";
    if (empty($price)) {
      	$msg1='<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert">×</button><strong>There is no Price Admin</strong>';
    }else{
   ...
   mysqli_query($con, "UPDATE transactions SET status =0  WHERE id = '$id'");
    if(mysqli_query($con,$query)) {
        $msg1= '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×</button><strong>Successful</strong>';
...
if (isset($_GET['del'])) {
    ...
    $msg="";
     $sql = mysqli_query($con, "SELECT * FROM transactions WHERE id ='$id'");
            ...
            $username=$ade['username'];
             if (empty($username)) {
      	$msg1='<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert">×</button><strong>The username is empty why bro</strong>';
    }else{
...
<marquee style="background-color: white; color:#d1026d; padding: 10px; font-size: 25px;;">If you have any problem using this script, contact Ad Developer -070133970 that is my official number </marquee>
						...
						<div class="col-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="success.php"> All Transactions</a></b></h5>
						...
						<div class="col-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="deposit.php"> Wallet summary</a></b></h5>
						...
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-3 ml-sm-0">
								<div class="numbers">
									...
									<h4 class="card-title">&#8358;<?php echo $total_balance;?>.00</h4>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="card card-stats card-round">
					<div class="card-body">
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-3 ml-sm-0">
								<div class="numbers">
									<p class="card-category">Total Referral </p>
									<h4 class="card-title"><?php $sql = "SELECT COUNT(*) AS total from referral";
...
<div class="col-sm-6 col-md-4">
						...
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-3 ml-sm-0">
								<div class="numbers">
									...
									<h4 class="card-title"><?php $sql = "SELECT COUNT(*) AS total from user WHERE status=1";
						...
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-3 ml-sm-0">
								<div class="numbers">
									...
									<h4 class="card-title"><?php $sql = "SELECT COUNT(*) AS total from user WHERE status=3";
						...
						<div class="row align-items-center">
							...
							<div class="col col-stats ml-3 ml-sm-0">
								<div class="numbers">
									...
									<h4 class="card-title"><?php $sql = "SELECT COUNT(*) AS total from user WHERE status=4";
 ...
 <div class="col s12 m6">
                   <div class="card  col s12 small hoverable ">
                           ...
                           <h5>Latest 5 Transactions<a class="right" href="transactions.php"><p style="text-align:right;">View All Transactions</a></p></h5>
                         </div>
                 ...
                 <td><?php echo htmlentities($nu);echo '.'; ?></td>
                  ...
                  <span>
                    ...
                    <span>
                      ...
                      if ($status == 1) {
                      ?>
                        <a href="success.php" class="text-primary" onclick="return confirm('Do you really want to leave this page?');" title="view pins"><i class="fa fa-forward" style="font-size:24px"></i>
                        <?php
                      } else {
                        ?>
