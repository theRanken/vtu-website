...
if(isset( $_SESSION['username'])) {
    $chek = mysqli_query($con,"SELECT * FROM  api");
...
$password = mysqli_real_escape_string($con,$_POST['password']);   
  ...
  if(!empty($host) && !empty($apikey) && !empty($username)){
$updat = mysqli_query($con,"UPDATE api SET host='$host',apikey='$apikey',username='$username',password='$password'  ") or die(mysqli_error()); 
  ...
  <script>
setTimeout(function(){ window.location.href='api.php' }, 1000);</script>
   ";
...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fa fa-cog" aria-hidden="true"></i> Api Setting </h3>
            </div>
</div>

<div class="container box">
   <br />
   <p>The Api key integration is self-integrated <a href="https://wa.me/2349035635150">Click Here To Learn More</a></p>
<form method="POST" >
       ...
       <div class="form-group">
            ...
            <label for="id_username" class=" requiredField">
                HOST<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="host"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['host']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
              ApiKey <span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="apikey"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['apikey']; ?>">
                     </div>
                   </div>
            ...
            <label for="id_username" class=" requiredField">
                Username<span class="asteriskField"></span>
                   ...
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="username"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['username']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
              Password<span class="asteriskField"></span>
                   ...
                   <div class="">
                      <div class="input-group-addon">
                    <input type="password" name="password"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['password']; ?>">
                     </div>
                     <br />
             <button type="submit" id="submit" name="setup" class="btn btn-info">Save Changes</button>
             </form>
