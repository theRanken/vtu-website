...
$password = mysqli_real_escape_string($con,$_POST['password']);   
  ...
  if(!empty($host) && !empty($sender) && !empty($username)){
$updat = mysqli_query($con,"UPDATE mail SET host='$host',sender='$sender',username='$username',password='$password'  ") or die(mysqli_error()); 
  ...
  <script>
setTimeout(function(){ window.location.href='email.php' }, 1000);</script>
   ";
...
<form method="POST" >
       ...
       <div class="form-group">
            ...
            <label for="id_username" class=" requiredField">
              Sender <span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="sender"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['sender']; ?>">
                     </div>
                   </div>
