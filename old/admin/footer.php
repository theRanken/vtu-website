...
$instergram = mysqli_real_escape_string($con,$_POST['instergram']);
$twitter = mysqli_real_escape_string($con,$_POST['twitter']);
$whatlink = mysqli_real_escape_string($con,$_POST['whatlink']);  
$whatgroup = mysqli_real_escape_string($con,$_POST['whatgroup']); 
      
  if(!empty($footer) && !empty($facebook) && !empty($youtube) && !empty($instergram) && !empty($twitter) && !empty($whatlink) && !empty($whatgroup)){
$updat = mysqli_query($con,"UPDATE general SET footer='$footer',facebook='$facebook',youtube='$youtube',instergram='$instergram',twitter='$twitter',whatlink='$whatlink',whatgroup='$whatgroup'  ") or die(mysqli_error()); 
  ...
  <script>
setTimeout(function(){ window.location.href='footer.php' }, 1000);</script>
   ";
...
<div class="container-fluid bg-secondary text-light"style="padding-bottom:10px;padding-top:5px;">
          <h3 class="mt-4"><i class="fa fa-cog" aria-hidden="true"></i> Settings </h3>
            </div>
</div>
...
<form method="POST" >
       ...
       <div class="form-group">
            ...
            <label for="id_username" class=" requiredField">
                Enter your whatsapp number with<br> your country code<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                     <input id="textarea" name="footer" class="textinput textInput form-control"  value="<?php echo $pdata['footer'];?>" required></input>
          </div>

        
            <label for="id_username" class=" requiredField">
                Facebook Link <span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="facebook"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['facebook']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
              YouTube Link<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="youtube"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['youtube']; ?>">
                     </div>
                   </div>
                     
        
            <label for="id_username" class=" requiredField">
                Instagram Link<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="instergram"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['instergram']; ?>">
                     </div>

            <label for="id_username" class=" requiredField">
              Twitter Link<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="twitter"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['twitter']; ?>">
                     </div>
 <label for="id_username" class=" requiredField">
              WhatsApp Link<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="whatlink"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['whatlink']; ?>">
                     </div>
                      <label for="id_username" class=" requiredField">
            WhatsApp Group Link<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="whatgroup"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['whatgroup']; ?>">
                     </div>
