...
$web = mysqli_real_escape_string($con,$_POST['web']);   
  ...
  if(!empty($name) && !empty($phone) && !empty($email) && !empty($web)){
$updat = mysqli_query($con,"UPDATE general SET name='$name',phone='$phone',email='$email',address='$address',web='$web'  ") or die(mysqli_error()); 
  ...
  <script>
setTimeout(function(){ window.location.href='setting.php' }, 1000);</script>
   ";
...
<div class="container box">
   <br />
   <h2 align="center">Please, be careful with the link make sure you input your website correct link details unless the website will crash</h2><br />
...
<form method="POST" >
       ...
       <div class="form-group">
            ...
            <label for="id_username" class=" requiredField">
                website Name<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="name"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['name']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
                Phone Number<span class="asteriskField"></span>
                   ...
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="phone"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['phone']; ?>">
                     </div>
            ...
            <label for="id_username" class=" requiredField">
              Email Address<span class="asteriskField"></span>
                   ...
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="email"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['email']; ?>">
                     </div>
                   </div>
            ...
            <label for="id_username" class=" requiredField">
                Address<span class="asteriskField"></span>
                   ...
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="address"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['address']; ?>">
                     </div>

            <label for="id_username" class=" requiredField">
              Website Link<span class="asteriskField"></span>
            </label>
        
                   <div class="">
                      <div class="input-group-addon">
                    <input type="text" name="web"  class="textinput textInput form-control" required id="" value="<?php echo $pdata['web']; ?>">
                     </div>
                     <br />
...
if ($_FILES["file"]["size"] > 800000) {
    $msg= "<div class='alert alert-danger'> file is too large!</div>";
    $uploadOk = 0;
}
...
if (file_exists($target_file)) {
    ...
    $msg= "<div class='alert alert-warning'>Sorry, file already exists. </div>";
    $uploadOk = 0;
...
// if everything is ok, try to upload file
  ...
  <div class='alert alert-success'>
    Image Changed Sucessfully
   <script>
setTimeout(function(){ window.location.href='setting.php' }, 1000);</script></div>";

$updatlogo = mysqli_query($con,"UPDATE general SET image='$newfilename'") or die(mysqli_error()); 

       
    } else {
        $msg= "<div class='alert alert-danger'>Sorry, there was an error uploading your 
file. </div>";
    };
};
...
<form action="" method="post" autocomplete = 'off' enctype="multipart/form-data" > 
  ...
  <div class="form-group">
     ...
     <img src="../upload/<?php echo $pdata['image'];?>"> 
         <div id="charNum"></div>
