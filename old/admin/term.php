...
$term =mysqli_real_escape_string($con, $_POST['term']);
  ...
  if(!empty($term)){
$updat = mysqli_query($con,"UPDATE terms SET adex='$term' ") or die(mysqli_error());
  ...
  <script>
setTimeout(function(){ window.location.href='term.php' }, 1000);</script>
   ";
       ...
       <div class="form-group">
          ...
          <label for="id_username" class=" requiredField">
                Front Page Price<span class="asteriskField"></span>
                   ...
                   <div class="">
                     <textarea id="textarea" name="term" class="textarea"  value="<?php echo $pdata['adex'];?>" required></textarea>
          </div>
