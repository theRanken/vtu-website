...
if (isset($_POST['sub'])) {
    ...
    $query1 = "SELECT * FROM user WHERE (username='$username' OR phone='$username') AND password1='$password1' AND status=1 ";
    $result1 = mysqli_query($con, $query1);
    
     $query2 = "SELECT * FROM user WHERE (username='$username'OR phone='$username') AND password1='$password1'  AND status=0 ";
    $result2 = mysqli_query($con, $query2);
    
     $query3 = "SELECT * FROM user WHERE (username='$username'OR phone='$username') AND password1='$password1'  AND status=2 ";
...
<?php
        ...
        $msg = "<h4 class='alert alert-danger'> Sorry <h5 class='alert alert-secondary'>$username</h5> Your Account has not been verified
     <a href='../signup/verification.php'>Click Here To Verify Your Account</a></h4>";
...
<head>
	...
	<title>Login - <?php echo $web['name']; ?> | Buy Data, Airtime to cash, Bills Payment</title>
...
<div class="form-group form-action-d-flex mb-3">
				   ...
				   <a href="../reset/" class="link float-right">Forgot Password ?</a>
