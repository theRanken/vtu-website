...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="width: 100% !important; height: 100%; -webkit-text-size-adjust: none; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; background-color: #F2F4F6; color: #51545E; margin: 0;" bgcolor="#F2F4F6">
    <span class="preheader" style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">Thanks for trying out <span>' .$web['name']. ' </span>. We’ve pulled together some information and resources to help you get started.</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">Welcome, <span>' .$user['name']. ' </span>!</h1>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Thanks for trying <span>' .$web['name']. ' </span>. We’re thrilled to have you on board. To get the most out of <span>' .$web['name']. ' </span>, do this primary next step:</p>
                        <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                    <a href="<span>' .$web['web'].'/login</span>" class="f-fallback button" target="_blank" style="color: #FFF; border-color: #3869d4; border-style: solid; border-width: 10px 18px; background-color: #3869D4; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Do this Next</a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                        ...
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">For reference, here is your login information:</p>
              ...
              <strong>Login Page:</strong> <span>'.$web['web'].'/login</span>
            </span>
                                  </td>
                                </tr>
                                <tr>
              ...
              <strong>Username:</strong> <span>' .$user['username']. ' </span>
                        ...
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">If you have any questions, feel free to <a href="mailto:<span>' .$web['email']. ' </span>" style="color: #3869D4;">email our customer success team</a>. (We are lightning quick at replying.) We also offer <a href="<span>' .$web['whatlink']. ' </span>" style="color: #3869D4;">live chat</a> during business hours.</p>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Thanks,
                          <br />ADEX DEVELOPER and the <span>' .$web['name']. ' </span> Team</p>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;"><strong>P.S.</strong> Need immediate help getting started? Check out our <a href="<span>' .$web['web']. ' </span>" style="color: #3869D4;">help documentation</a>. Or, just reply to this email, the <span>' .$web['name']. ' </span> support team is always ready to help!</p>
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation" style="margin-top: 25px; padding-top: 25px; border-top-width: 1px; border-top-color: #EAEAEC; border-top-style: solid;">
                          <tr>
                            <td style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                              <p class="f-fallback sub" style="font-size: 13px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">If you are having trouble with the button above, copy and paste the URL below into your web browser.</p>
