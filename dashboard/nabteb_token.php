...
$das="";
    ...
    $card_checking = mysqli_query($con, "SELECT * FROM nabteb_result_token WHERE status='0' ");
    if (mysqli_num_rows($card_checking) > 0) {
    } else { ?>
        <script>
            alert("Nabteb result token is currently out of stock please check back later");
        </script>
        <script>
...
<div style="padding:90px 15px 20px 15px" >
                            ...
                            <h2 class="w3-center"> Generate Nabteb Result Checker</h2>
                            <div outpc=""><?= $msg; ?></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div id="div_id_exam_name" class="form-group">
                                                ...
                                                <input type="text" name="dbcheck" class="form-control" value="nabteb_result_token" hidden />
                                                <input type="text" name="card_type" class="form-control" value="NABTEB RESULT CHECKER" hidden />
