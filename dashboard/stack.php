...
$callback_url = "https://$request_dir/dashboard/stackcheck.php";  // url to go to after payment
$curl = curl_init();
...
CURLOPT_HTTPHEADER => [
    "authorization: Bearer $pstack", //replace this with your own test key
						...
						<div class="box">
							...
							<div class="row">
								...
								<div class="col-sm-8">
									...
									<input type="hidden" name="csrfmiddlewaretoken" value="vlHeVAsGpWxhVbvdnM4Yjnnt2X9JwgNPjGQ1jp98i4dHttBGHlhm6DnM4h4lHFqZ">
