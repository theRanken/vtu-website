...
$das="";
    ...
    $card_checking = mysqli_query($con, "SELECT * FROM neco_result_token WHERE status='0' ");
    if (mysqli_num_rows($card_checking) > 0) {
    } else { ?>
        <script>
            alert("Neco result token is currently out of stock please check back later");
        </script>
        <script>
        ...
        ?>
            ...
            <table class="table-curved">
                ...
                <?php $nu = $nu + 1;
                        $username=$row['username'];
                            //update card status
                            $update_card = mysqli_query($con, "UPDATE neco_result_token SET status='1',buyer_id='$username',time_bought=NOW() WHERE id='$card_id'");
                            //update buyer bal
                            $rem_bal = $bal - $amount;
    ...
    <?php
            ...
            $msg = '<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert">×</button><strong>Please put how many pins you to buy </strong>';
        }
    }
...
<div style="padding:90px 15px 20px 15px" >
                            ...
                            <h2 class="w3-center"> Generate Neco Token(s)</h2>
                            <div outpc=""><?= $msg; ?></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div id="div_id_exam_name" class="form-group">
                                                ...
                                                <input type="text" name="dbcheck" class="form-control" value="neco_result_token" hidden />
                                                <input type="text" name="card_type" class="form-control" value="NECO RESULT TOKEN" hidden />
