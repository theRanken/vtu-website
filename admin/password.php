...
<div style="padding:90px 15px 20px 15px" >
 ...
 <div id="div_id_amount" class="form-group">
            ...
            USERNAME
                ...
                <div class="">
                    <input type="text"  id="username" name="refbal" class="textinput textInput form-control" value="<?php echo $adex['username']; ?>"</input>
...
<div id="div_id_amount" class="form-group">
            ...
            <label for="id_amount" class="">
                ...
                <div class="">
                    <input type="email"  id="email" name="refprice" class="textinput textInput form-control" value="<?php echo $adex['email']; ?>"</input>
 ...
 <div id="div_id_amount" class="form-group">
            ...
            <label for="id_amount" class="">
               PASSWORD
                ...
                <div class="">
                    <input type="password" id="password" name="airtime" class="textinput textInput form-control" value="<?php echo $adex['password1']; ?>"</input>
