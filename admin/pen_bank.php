			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Pending Bank Payment</h4>
					</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
				    <?php
                $query = "SELECT * FROM bankpayment WHERE status='0'" or die(mysqli_error());
...
<!------ unapprove user ----->
 ...
 swal({
  title: "Dear <?php echo $row['username'];?>",
  text: "Aproving this transactions means the user will be credited",
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
            ...
            dataType: 'json',
                      success: function (response) {
                          if (response.status == 500){
                            ...
                            swal({
                              title: "Successful!",
                              text: "Sou have successfully credited" + ' ' + response.username + ' ' + "N" + response.amount,
                              icon: "Success",
                              button: "Okay",
                            })
                            $('.swal-button--confirm').click(function(){
