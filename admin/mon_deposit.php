			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Monnify Deposit</h4>
					</div>
...
<div class="col-md-12">
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
				    <?php
                $query = "SELECT * FROM deposit WHERE status='1'" or die(mysqli_error());
                ...
                ?>
												<tr>
													...
													<td><? echo number_format($charge); ?></td>
													<td><? echo $trans; ?></td>
													<td><? echo $date; ?></td>
...
<!------ unapprove user ----->
 ...
 swal({
  title: "Dear <?php echo $row['username'];?>",
  text: "Approving means the user will be credited",
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
            ...
            dataType: 'json',
                      success: function (response) {
                          if (response.status == 500){
                            ...
                            swal({
                              title: "Successful!",
                              text: "you have successfully credited" + ' ' + response.username + ' ' + "N" + response.amount,
                              icon: "Success",
                              button: "Okay",
                            })
                            $('.swal-button--confirm').click(function(){
