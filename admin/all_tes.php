			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Approved Testimony</h4>
					</div>
							<div class="card">
								<div class="card-header">
									<div class="card-title">Hello, <?php echo $row['username']; ?> welcome back (Dataplan dey greet you oo)</div>
								</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
				    <?php
                $query = "SELECT * FROM rate WHERE status='1'" or die(mysqli_error());
...
<!------ unapprove user ----->
 ...
 swal({
  title: "Dear <?php echo $row['username'];?>",
  text: "Are you sure you want to unapprove this testimony?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
            ...
            dataType: 'json',
                      success: function (response) {
                          if (response.status == 500){
                            ...
                            swal({
                              title: "Successful!",
                              text: "You successfully unapproved this testimony",
                              icon: "Success",
                              button: "Okay",
                            })
                            $('.swal-button--confirm').click(function(){
