...
<div style="padding:90px 15px 20px 15px" >
    ...
    <h2 class="w3-center">2cash Discount</h2>
...
var mobile = $("#9mobile").val();
  ...
  text: "Are  you  sure you want to update the airtime 2cash dicount",
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
            ...
            dataType: 'json',
                      success: function (response) {
                          if (response.status == 500){
                            ...
                            swal({
                              title: "Successful!",
                              text: "You have successfully updated the airtme2cash discount",
                              icon: "success",
                              button: "Okay",
                            })
