			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Approved Airtime 2 Cash</h4>
					</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
				    <?php
                $query = "SELECT * FROM airtime WHERE status='1'" or die(mysqli_error());
                          ...
                          echo "<span class='btn btn-danger' id=str" . $use['id'] . ">Canceled</span>";
													...
													<td>
														<div class="form-button-action">
															...
															<button type="button" data-toggle="tooltip" title=""onclick="active_unapprove_user(this.value)"  value="<?php echo $id; ?>" class="btn btn-link btn-danger" data-original-title="Unappprove">
...
<!------ unapprove user ----->
 ...
 swal({
  title: "Dear <?php echo $row['username'];?>",
  text: "Unapprove this transaction",
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
