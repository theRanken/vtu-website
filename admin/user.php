...
<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title">Verified Users</h4>
		</div>
		<div class="card">
					...
					<div class="card-body">
						...
						<div class="table-responsive">
							<table id="add-row" class="display table table-striped table-hover" >
								...
								<tbody>
									<?php
										$query = "SELECT * FROM user WHERE status='1'" or die(mysqli_error($con));
									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												...
												<button type="button" data-toggle="tooltip" title=""onclick="active_unapprove_user(this.value)"  value="<?php echo $username; ?>" class="btn btn-link btn-danger" data-original-title="Unappprove User">
...
<script type="text/javascript">
	...
	swal({
	title: "Dear <?php echo $row['username'];?>",
	text: "Are  you  sure you want to Unapprove " + ' ' + val,
	icon: "warning",
	buttons: true,
	dangerMode: true,
	}) 
	          ...
	          dataType: 'json',
	                    success: function (response) {
	                        if (response.status == 500){
	                          ...
	                          swal({
	                            title: "Successful!",
	                            text: "You successfully Unapprove" + ' ' + val,
	                            icon: "success",
	                            button: "Okay",
	                          })
	                          $('.swal-button--confirm').click(function(){
