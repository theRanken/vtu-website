			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Unpaid Loan Activities</h4>
					</div>
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
				    <?php
                $query = "SELECT * FROM loan WHERE status='1'" or die(mysqli_error());
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/jquery.validate.min.js"></script>
 ...
 swal({
  ...
  text: "Are  you  sure you want to debit this user for the loan",
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
            ...
            dataType: 'json',
                      success: function (response) {
                          if (response.status == 500){
                            ...
                            swal({
                              title: "Successful!",
                              text: "You successfully Debited" + ' ' + response.username + ' ' + "N" + response.amount,
                              icon: "success",
                              button: "Okay",
                            })
