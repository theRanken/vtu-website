...
<div style="padding:90px 15px 20px 15px" >
    ...
    <h2 class="w3-center">Debit User account</h2>
...
var amount = $("#amount").val();
  ...
  text: "Are  you  sure you want to Debit " + ' ' + username + ' ' + amount,
  icon: "warning",
  buttons: true,
  dangerMode: true,
}) 
            ...
            dataType: 'json',
                      success: function (response) {
                          if (response.status == 500){
                            ...
                            swal({
                              title: "Successful!",
                              text: "You successfully Debited " + ' ' + username + ' ' + amount,
                              icon: "success",
                              button: "Okay",
                            })
